...
\begin{exe}
    \ex Я знал, что Дима выучил аж $ [\textsc{иврит}]_F $. \begin{xlist}
        \ex \textit{Узкое прочтение:} Изучение иврита маловероятно (для Димы).
        \ex \# \textit{Широкое прочтение:} Осведомленность об изучении Димой иврита маловероятна. 
    \end{xlist}
\end{exe}
...
\begin{exe}
    \ex Я знал, что Дима выучил хотя бы $ [\textsc{иврит}]_F $. \begin{xlist}
        \ex \textit{Узкое прочтение:} Дима выучил как минимум иврит.
        \ex \# \textit{Широкое прочтение:}  Я, как минимум, знал, что Дима выучил иврит. 
    \end{xlist}
\end{exe}

Однако в некоторых случаях скрытое передвижение возможно:

\begin{exe}
    \ex Я не хотел, чтобы Дима изучал даже $ [\textsc{иврит}]_F $. \begin{xlist}
        \ex \textit{Узкое прочтение:} Дима изучал несколько языков, а в какой-то момент начал изучать и иврит. Я не хотел, чтобы так случилось.
...
\begin{exe}
    \ex Я не хотел, чтобы Дима изучал аж $ [\textsc{иврит}]_F $. \begin{xlist}
        \ex \textit{Узкое прочтение:} 
        \ex \textit{Широкое прочтение:}
    \end{xlist}
\end{exe}

\begin{exe}
    \ex Я не хотел, чтобы Дима изучал только $ [\textsc{иврит}]_F $. \begin{xlist}
        \ex \textit{Узкое прочтение:} 
        \ex \textit{Широкое прочтение:}
    \end{xlist}
\end{exe}
...
\begin{exe}
    \ex Я не хотел, чтобы Дима изучал хотя бы $ [\textsc{иврит}]_F $. \begin{xlist}
        \ex \textit{Узкое прочтение:} 
        \ex \textit{Широкое прочтение:}
    \end{xlist}
\end{exe}
...
\begin{exe}
    \ex \begin{xlist}
        ...
        \ex \label{azhNPInegated} *Он не спал аж $ [\textsc{два дня}]_F $.
    \end{xlist}
\end{exe}
...
С другой стороны, из-за стативного прочтения мы можем предполагать уменьшенную структуру глагольной группы, вследствие чего обстоятельства времени могут быть вынуждены находиться в более высокой позиции. Решение данной проблемы мы предлагаем оставить для будущих исследований.
