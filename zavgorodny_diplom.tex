...
\begin{exe}
    \ex \label{derivingStruct}
        \begin{align*}
            ...
            gave\ [Kyle]_{F}\ cigarettes            &\mapsto \langle \lambda x. Give(x)(c), k \rangle       \\
...
\begin{exe}
    \ex \label{derivingStruct}
        \begin{align*}
            ...
            only\ gave\ [Kyle]_{F}\ cigarettes           &\mapsto \langle \lambda x.\forall \gamma [\lambda \beta.Give(\beta)(c)](\gamma)(x) \rightarrow \gamma = b \rangle       \\
