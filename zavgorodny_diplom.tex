...
\begin{exe}
    \ex I knew that John had learnt even $ [\textsc{Spanish}]_F $. \begin{xlist}
        ...
        \ex \textit{Широкое прочтение:} Моё знание изучения Джоном испанского языка маловероятно. 
    \end{xlist}
\end{exe}
...
\begin{exe}
    \ex Я знал, что Дима выучил даже $ [\textsc{иврит}]_F $. \begin{xlist}
        ...
        \ex \# \textit{Широкое прочтение:} Моё знание изучения Димой иврита маловероятно. 
    \end{xlist}
\end{exe}
...
\begin{exe}
    \ex Я знаю, что Лёша съездил аж $[$\textsc{в США}$]_F$. \begin{xlist}
        \ex \textit{Узкая сфера действия.} Поездка в США не входила в планы Лёши, но он всё-таки посетил эту страну.
        \ex \# \textit{Широкая сфера действия.} Передвижения Лёши --- большая тайна, но мне известно даже про его поездку в США.
    \end{xlist}
\end{exe}

\subsubsection{\textit{Aж} и отрицание}

В примере (\ref{azhPPI}) демонстрируется неспособность \textit{аж} находиться в сфере действия сентенциального отрицания:

\begin{exe}
    \ex \label{azhPPI} \begin{xlist}
        \ex Таня курила аж в кабинете директора. 
        \ex \# Таня не курила аж в кабинете директора.
    \end{xlist}
\end{exe}

Скорее всего, можно утверждать, что \textit{аж} является элементом с положительной полярностью (англ. \textit{PPI}); особенности дистрибуции \textit{аж} подтверждают эту гипотезу:
...
\begin{exe}
    \ex \begin{xlist}
        ...
        \ex \label{azhDoubleNeg} Никто не утверждает, что Таня не курила аж в кабинете директора.
    \end{xlist}
\end{exe}

В (\ref{azhMatrixNeg}) \textit{аж} без особых проблем существует при отрицании в матричной клаузе, в (\ref{azhAlwaysNeg}) оно может употребляться ``под защитой'' кванторного наречия \textit{всегда}, а в (\ref{azhDoubleNeg}) употребление \textit{аж} возможно в контексте двойного отрицания; все приведенные контексты входят в (считающуюся типичной) дистрибуцию PPI.

\subsection{{Хотя бы}} \label{xot}

\subsection{Хоть} \label{xotyaBy}
