...
\begin{exe}
    \ex \label{azhNegativeEvents} \begin{xlist}
        ...
        % \ex \textit{Вася работает в правительстве и постоянно совершает глупые ошибки, чем раздражает своё начальство.} \\
        % В этот раз Вася не угодил аж $ [\textsc{премьер-министру}]_F $, у него будут проблемы.
...
% С учетом всего вышесказанного представляется разумным проверить предскзазания теории \citep{fabergas2017building} для русского \textit{аж} под отрицанием, и если факты будут говорить в пользу версии с отрицательным событием --- рассмотреть часть исследования \citep{fabergas2017building}, затрагивающую синтаксис отрицательных событий.
