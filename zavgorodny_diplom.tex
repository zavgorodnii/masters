...
Под фокусным оператором мы будем понимать лексический элемент, чувствительный к фокусу и взаимодействующий со значением модифицируемой пропозиции. Употребление фокусного оператора в высказывании с фокусом может привести к тому, что место фокуса начинает влиять на истинностное значение высказывания. Примером такого элемента может служить (\ref{truthValues}), который мы повторяем ниже как (\ref{truthValuesAgain}):
