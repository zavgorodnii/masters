...
\begin{table}
    ...
    \multicolumn{4}{c}{Аддитивные операторы} \\[10pt] \hline
    Нескалярные & \multicolumn{3}{c}{Обобщенные} \\[10pt] \cline{2-4}
    ~ & Высокие & \multicolumn{2}{c}{Низкие} \\[10pt] \cline{3-4}
    ~ & ~ & Отрицательные & Неотрицательные \\[10pt]
    \end{tabular}
\end{table}
